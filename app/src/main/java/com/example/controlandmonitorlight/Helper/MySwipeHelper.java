...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public class MyButton{
        ...
        public MyButton( Context context,String text, int textsize, int imageid, int color, MyButtonClickListener listener) {
            this.text = text;
        ...
        public void onDraw(Canvas c , RectF rectF, int pos ) {
            ...
            if(imageid == 0)
            {
                ...
                y = cHeight/2f + r.height() - r.height() ;
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if(buttonBuffer.containsKey(swipePosition))
            ...
            buttonList.clear();
        buttonBuffer.clear();
        swipeThreshold = (float) (0.5 * buttonList.size()*buttonWidth);
        recoverSwipedItem();
    }
